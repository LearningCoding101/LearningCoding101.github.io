...
export default function TypeInAnswerModal({ isOpen, onClose, onResult }) {
  if (!isOpen) return null;
  return (
    <div className="gameplay-overlay open">
      <div className="gameplay-sheet">
        <h2 className="gameplay-title">Type In Answer (placeholder)</h2>
        <p style={{ textAlign: "center" }}>Placeholder text input question.</p>
